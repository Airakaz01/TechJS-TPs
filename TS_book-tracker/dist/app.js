...
mongoose.connect(mongoURI)
    ...
    .catch((err) => console.error('Erreur de connexion à MongoDB :', err)); // Message d'erreur avec type
...
passport.use(new LocalStrategy({ usernameField: 'username' }, async (username, password, done) => {
    ...
    catch (err) { // Type 'any' pour l'erreur pour la flexibilité, ou un type plus spécifique si connu
...
passport.deserializeUser(async (id, done) => {
    ...
    catch (err) { // Type 'any' pour l'erreur
