...
import { BookFormat, BookStatus } from '../types/book.js'; // Interfaces et Enums pour les livres
const router = Router();
...
router.post('/add', ensureAuthenticated, async (req, res) => {
    ...
    const { title, author, numberOfPages: numberOfPagesStr, status, price: priceStr, numberOfPagesRead: numberOfPagesReadStr, format, suggestedBy } = req.body;
